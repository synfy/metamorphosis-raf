package net.metamorphosis.raf.common.fluids;
...
public class MilkFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return MetamorphosisRAF.STILL_MILK;
    }
    ...
    public Fluid getFlowing() {
        return MetamorphosisRAF.FLOWING_MILK;
    }
    ...
    protected BlockState toBlockState(FluidState fluidState) {
        return MetamorphosisRAF.MILK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
